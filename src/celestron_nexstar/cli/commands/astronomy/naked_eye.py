...
def show_tonight(
    ...
    if export:
        ...
        asyncio.run(_show_tonight_content(file_console))
    ...
    asyncio.run(_show_tonight_content(console))


async def _show_tonight_content(output_console: Console | FileConsole) -> None:
    """
