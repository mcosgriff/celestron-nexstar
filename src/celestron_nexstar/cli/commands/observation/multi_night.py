        ...
        for day_offset in range(days):
            ...
            if sunrise:
                ...
                if moon_info:
                    ...
                    moon_separation_score, moon_separation_deg = calculate_moon_separation_score(
                        obj.ra_hours,
                        obj.dec_degrees,
                        moon_info.ra_hours,
                ...
                total_score = calculate_object_type_score(
                    obj,
                    conditions,
                    visibility,
    ...
    try:
        ...
        if nighttime_only:
            filtered_chart_data = [
                ...
                if isinstance(data["timestamp"], datetime) and is_nighttime(data["timestamp"], lat, lon)
            ]
...
def _is_nighttime_cached(timestamp_iso: str, lat: float, lon: float) -> bool:
    ...
    return is_nighttime(timestamp, lat, lon)
