...
class TestGetSolarWindData(unittest.TestCase):
    ...
    @patch("celestron_nexstar.api.events.space_weather.requests.get")
    def test_get_solar_wind_data_success(self, mock_requests_get, mock_get_cache):
        ...
        mock_requests_get.side_effect = [mock_plasma_response, mock_mag_response]
    ...
    @patch("celestron_nexstar.api.events.space_weather._get_from_cache")
    @patch("celestron_nexstar.api.events.space_weather.requests.get")
    def test_get_solar_wind_data_empty_response(self, mock_requests_get, mock_get_cache):
    ...
    @patch("celestron_nexstar.api.events.space_weather._get_from_cache")
    @patch("celestron_nexstar.api.events.space_weather.requests.get")
    def test_get_solar_wind_data_error(self, mock_requests_get, mock_get_cache):
...
class TestGetGoesXrayData(unittest.TestCase):
    ...
    @patch("celestron_nexstar.api.events.space_weather.requests.get")
    def test_get_goes_xray_data_success(self, mock_requests_get):
    ...
    @patch("celestron_nexstar.api.events.space_weather.requests.get")
    def test_get_goes_xray_data_empty(self, mock_requests_get):
    ...
    @patch("celestron_nexstar.api.events.space_weather.requests.get")
    def test_get_goes_xray_data_error(self, mock_requests_get):
...
class TestGetKpApData(unittest.TestCase):
    ...
    @patch("celestron_nexstar.api.events.space_weather._get_from_cache")
    @patch("celestron_nexstar.api.events.space_weather.requests.get")
    def test_get_kp_ap_data_success(self, mock_requests_get, mock_get_cache):
    ...
    @patch("celestron_nexstar.api.events.space_weather._get_from_cache")
    @patch("celestron_nexstar.api.events.space_weather.requests.get")
    def test_get_kp_ap_data_error(self, mock_requests_get, mock_get_cache):
...
class TestGetSpaceWeatherConditions(unittest.TestCase):
    ...
    @patch("celestron_nexstar.api.events.space_weather.get_proton_flux_data")
    @patch("celestron_nexstar.api.events.space_weather.get_radio_flux_107")
    ...
    def test_get_space_weather_conditions_complete(
        self,
        mock_solar_wind,
        mock_xray,
        mock_kp,
        ...
        mock_radio_flux.return_value = None
        mock_proton_flux.return_value = {}
